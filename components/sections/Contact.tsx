  ...
  const contactMethods = [
    {
      ...
      wrapClass:
        "p-5 rounded-[1.5rem] bg-white/5 border border-white/10 group-hover/item:bg-blue-500/10 group-hover/item:border-blue-500/20 transition-all duration-500",
      iconClass: "text-gray-400 group-hover/item:text-blue-400 transition-colors",
      valueClass: "text-white text-lg font-bold group-hover/item:text-blue-400 transition-colors",
    },
    {
      icon: Phone,
      label: "Phone",
      ...
      wrapClass:
        "p-5 rounded-[1.5rem] bg-white/5 border border-white/10 group-hover/item:bg-emerald-500/10 group-hover/item:border-emerald-500/20 transition-all duration-500",
      iconClass: "text-gray-400 group-hover/item:text-emerald-400 transition-colors",
      valueClass: "text-white text-lg font-bold group-hover/item:text-emerald-300 transition-colors",
    },
  ] as const
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-tight">
                Let’s <span className="text-white/40 italic">Build.</span>
              </h2>
            ...
            <div className="flex gap-5">
              {[
                ...
                <a
                  ...
                  aria-label={social.href.includes("linkedin") ? "LinkedIn" : "GitHub"}
                >
                  <social.icon size={24} />
                </a>
              ))}
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/[0.03] backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-12 border border-white/10 space-y-8 flex flex-col justify-center h-full">
              <div className="space-y-3">
                <h3 className="text-2xl md:text-3xl font-black text-white tracking-tight">Quick Intro</h3>
